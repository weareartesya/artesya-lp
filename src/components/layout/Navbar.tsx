  ...
  return (
    <motion.header 
      className={`w-full fixed top-0 left-0 z-40 backdrop-blur-md border-b transition-all duration-300 ${
        scrolled 
          ? 'bg-background/95 shadow-lg border-border/30' 
    ...
    >
      <div className="container flex items-center justify-between h-16">
        ...
        >
          <Link to="#home" className="font-serif text-xl tracking-wide font-semibold">
            Artesya
          </Link>
        </motion.div>
      ...
      {/* Mobile Navigation */}
      <motion.div
        className={`md:hidden absolute top-full left-0 w-full bg-background/95 backdrop-blur-md border-b border-border/20 ${
