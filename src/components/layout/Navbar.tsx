    ...
    <header className="w-full fixed top-0 left-0 z-40 bg-background/60 backdrop-blur-md border-b border-border/20">
      <div className="container flex items-center justify-between h-14">
        ...
        <nav className="hidden md:flex items-center gap-6 text-sm text-muted-foreground">
          <a href="#icp" className="hover:text-foreground transition-colors">Quem atendemos</a>
          <a href="#produtos" className="hover:text-foreground transition-colors">Produtos</a>
          <a href="#fluxo" className="hover:text-foreground transition-colors">Como trabalhamos</a>
